...
const Banner = () => {
    return (
        <div class="px-6 py-12 md:px-12 text-center lg:text-left background-radial-gradient">
            <div class="container mx-auto xl:px-32">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="mt-12 lg:mt-0">
                        <h1 class="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12 text-white">The best offer <br /><span className='text-blue-500'>for your business</span></h1>
