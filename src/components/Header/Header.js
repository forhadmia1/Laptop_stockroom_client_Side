                ...
                <div className="container w-full flex flex-wrap items-center justify-between px-6">
                    ...
                    <div className="collapse navbar-collapse flex-grow items-center" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav flex flex-col pl-2 list-style-none ml-auto md:items-center">
                            ...
                            {!user ?
                                <li className="nav-item pr-2">
                                    <button onClick={() => navigate('/login')} type="button" class="inline-block px-6 py-2.5 bg-blue-400 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-500 hover:shadow-lg focus:bg-blue-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-600 active:shadow-lg transition duration-150 ease-in-out">Login</button>
                                </li> :
                                <>
                                    <li className="nav-item pr-2">
